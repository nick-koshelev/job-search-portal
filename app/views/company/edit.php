...
<div class="container shadow pb-2 h-100 flex-grow-1">
    <div class="p-5">
        <p class="h1 mb-4">Edit company</p>
        <div class="pt-2">
            <form class="ms-2" action="/company/edit?id=<?= $company->id ?? "" ?>" method="post">
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-3">
                        <input type="email" class="form-control" id="email" name="email" value="<?= $company->contactEmail ?? "" ?>">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="phone" class="col-sm-2 col-form-label">Phone</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="phone" name="phone" value="<?= $company->contactPhone ?? "" ?>">
                    </div>
                </div>
                <div class="mb-3 row">
                    <div class="col-sm-3 offset-sm-2">
                        <div class="float-end">
                            <a href="/company" class="btn btn-danger ms-2">Cancel</a>
